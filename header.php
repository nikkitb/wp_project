                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="<?php the_field('contact_mail', 2); ?>" class="header__contacts-mail"><?php the_field('contact_mail', 2); ?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="<?php the_field('contact_numbers', 2); ?>"><?php the_field('contact_numbers', 2); ?></a>
                                    <a href="<?php the_field('contact_numbers_2', 2); ?>"><?php the_field('contact_numbers_2', 2); ?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
