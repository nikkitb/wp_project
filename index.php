...
?>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('info_weight', 2)?></span> <?php the_field('info', 2)?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php the_field('descr_header', 2) ?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('item_header', 2) ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('item_text', 2) ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('item_img') ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('item_img_s') ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('item_header_s') ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('item_text_s') ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('item_header_t') ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('item_text_t') ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('item_img_t') ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834347"><?php the_field('contact_numbers', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834358"><?php the_field('contact_numbers_2', 2) ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                Или напишите нам на почту
                                <a href="<?php the_field('contact_mail', 2) ?>"><?php the_field('contact_mail', 2) ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
...
<?php 
    ...
    do_action( 'my_hook', 'Dear', 'Nikitos' );
