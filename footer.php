                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('yt_link', 2) ?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                  <a href="<?php the_field('contact_numbers'); ?>"><?php the_field('contact_numbers'); ?></a>
                                  <a href="<?php the_field('contact_numbers_2'); ?>"><?php the_field('contact_numbers_2'); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
